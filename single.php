...
<div class="post clearfix">
    ...
    <div class="entry clearfix">
		...
		$full_img = wp_get_attachment_image_src(get_post_thumbnail_id(), 'full-size');
			?>
        		<div class="post-thumbnail">
        			<a href="<?php echo $full_img[0]; ?>" title="<?php the_title(); ?>" class="prettyphoto-link"><img src="<?php echo $blog_thumb[0]; ?>" alt="<?php echo the_title(); ?>" /></a>
                </div>
                <!-- /post-thumbnail -->
        <?php } ?>
        ...
        if($data['enable_disable_blog_comments'] != 'disable') {
        comments_template(); } ?>
